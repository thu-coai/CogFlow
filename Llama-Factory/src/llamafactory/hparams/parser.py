...
def get_train_args(args: Optional[Union[dict[str, Any], list[str]]] = None) -> _TRAIN_CLS:
    ...
    if finetuning_args.stage in ["rm", "ppo", "rm_class"] and training_args.load_best_model_at_end:
        raise ValueError("RM, RM_CLASS and PPO stages do not support `load_best_model_at_end`.")
    ...
    if finetuning_args.stage in ["rm", "ppo", "rm_class"] and finetuning_args.finetuning_type in ["full", "freeze"]:
    ...
    if (
        finetuning_args.stage in ["rm", "ppo", "rm_class"]
        and finetuning_args.finetuning_type == "lora"
